...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_gazebo_SOURCE_PREFIX /home/hoggaan/Desktop/research_ws/src/turtlebot3_simulations/turtlebot3_gazebo)
  set(turtlebot3_gazebo_DEVEL_PREFIX /home/hoggaan/Desktop/research_ws/devel)
  ...
  set(turtlebot3_gazebo_INSTALL_PREFIX /home/hoggaan/Desktop/research_ws/install)
...
if(NOT "/home/hoggaan/Desktop/research_ws/src/turtlebot3_simulations/turtlebot3_gazebo/include;/home/hoggaan/local/include;/home/hoggaan/local/include/gazebo-11;/usr/include/bullet;/usr/include/simbody;/usr/include;/usr/include/sdformat-9.8;/usr/include/ignition/math6;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport8;/usr/include/ignition/msgs5;/usr/include/ignition/common3;/usr/include/ignition/fuel_tools4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hoggaan/Desktop/research_ws/src/turtlebot3_simulations/turtlebot3_gazebo/${idir}'.  ${_report}")
    endif()
    _list_append_unique(turtlebot3_gazebo_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "BulletSoftBody;BulletDynamics;BulletCollision;LinearMath;/usr/lib/x86_64-linux-gnu/libSimTKcommon.so.3.6;/usr/lib/x86_64-linux-gnu/libSimTKmath.so.3.6;/usr/lib/x86_64-linux-gnu/libSimTKsimbody.so.3.6;/usr/lib/x86_64-linux-gnu/libdart.so.6.9.2;/home/hoggaan/local/lib/libgazebo.so;/home/hoggaan/local/lib/libgazebo_client.so;/home/hoggaan/local/lib/libgazebo_gui.so;/home/hoggaan/local/lib/libgazebo_sensors.so;/home/hoggaan/local/lib/libgazebo_rendering.so;/home/hoggaan/local/lib/libgazebo_physics.so;/home/hoggaan/local/lib/libgazebo_ode.so;/home/hoggaan/local/lib/libgazebo_transport.so;/home/hoggaan/local/lib/libgazebo_msgs.so;/home/hoggaan/local/lib/libgazebo_util.so;/home/hoggaan/local/lib/libgazebo_common.so;/home/hoggaan/local/lib/libgazebo_gimpact.so;/home/hoggaan/local/lib/libgazebo_opcode.so;/home/hoggaan/local/lib/libgazebo_opende_ou.so;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_program_options.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_regex.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_iostreams.so.1.71.0;/usr/lib/x86_64-linux-gnu/libprotobuf.so;-lpthread;/usr/lib/x86_64-linux-gnu/libsdformat9.so.9.8.0;optimized;/usr/lib/x86_64-linux-gnu/libOgreMain.so;debug;/usr/lib/x86_64-linux-gnu/libOgreMain.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_date_time.so.1.71.0;optimized;/usr/lib/x86_64-linux-gnu/libOgreTerrain.so;debug;/usr/lib/x86_64-linux-gnu/libOgreTerrain.so;optimized;/usr/lib/x86_64-linux-gnu/libOgrePaging.so;debug;/usr/lib/x86_64-linux-gnu/libOgrePaging.so;/usr/lib/x86_64-linux-gnu/libignition-math6.so.6.12.0;/usr/lib/x86_64-linux-gnu/libignition-transport8.so.8.3.0;/usr/lib/x86_64-linux-gnu/libignition-msgs5.so.5.10.0;/usr/lib/x86_64-linux-gnu/libignition-common3-graphics.so.3.14.1;/usr/lib/x86_64-linux-gnu/libignition-fuel_tools4.so.4.5.0")
