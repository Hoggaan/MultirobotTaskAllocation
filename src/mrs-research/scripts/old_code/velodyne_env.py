...
class GazeboEnv:
    ...
    def __init__(self, launchfile, height, width, nchannels):
        ...
        self.set_self_state = ModelState() # Setting the model state of the robot imediately after spawning.
        ...
        self.distOld = math.sqrt(math.pow(self.odomX - self.goalX, 2) + math.pow(self.odomY - self.goalY, 2)) # Old Distance
    ...
    def step(self, act):
        ...
        #     try:
        #         dataOdom = rospy.wait_for_message('/burger/odom', Odometry, timeout=0.1)
        #     except:
        #         pass
        ...
        # while data is None:
        #     try:
        #         data = rospy.wait_for_message('/burger/front_laser/scan', LaserScan, timeout=0.1)
        #     except:
        #         pass
        # time.sleep(0.1)
